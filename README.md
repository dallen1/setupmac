### Setupmac
Forked to automate cask package updates on my systems. 
...
```
curl -s https://raw.githubusercontent.com/dallen1/setupmac/master/start.sh | /bin/bash
```
...
what get's installed at [here](https://raw.githubusercontent.com/dallen1/setupmac/master/roles/setup/vars/main.yml). If you want to change the list of applications, clone
